...
const Explore = () => {
    ...
    return (
        <div>
            <h2 class="d-inline-flex justify-content-center" style={{ color: "white", margin: "20px", backgroundColor: '#5a287d', padding: '5px' }} >How do emails create a carbon footprint? </h2>
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex justify-content-lg-start align-items-center">
                        ...
                        <br/><div style={{ padding: '20px', marginLeft: "100px" }}><img src={mail_data} ></img></div>
                    </div>
                    <div class="d-flex justify-content-lg-start ">
                        {showtwo ? <img src={two} height={250} width={250}></img> :""}
                    ...
                    <div class="d-flex justify-content-lg-start" style={{marginTop:"50px"}}>
                        ...
                        {showthree ? <div className='step_3'>
                            ...
                            {/* <button class="align-self-center" style={{backgroundColor:"#5a287d",color:"white"}} onClick={showSolution}>Solution</button> */}
                        </div> : ""}
                    </div>
